...
<img src="packages/core/examples/output.png" height="192" align="right" />
...
| <img src="packages/core/examples/style-square.png" height="160" />  | <img src="packages/core/examples/style-circle.png" height="160" />  |
| ------------------------------------------------- | ------------------------------------------------- |
| <img src="packages/core/examples/style-rounded.png" height="160" /> | <img src="packages/core/examples/style-diamond.png" height="160" /> |
...
<img src="packages/core/examples/eyes.png" height="128" align="right" />
...
| ----------------------------------- | ----------------- | ------------------------------------------------------------ |
| [`sqrc`](./packages/core)           | `packages/core`   | The library published to npm.                                |
| [`@sqrc/web-ui`](./packages/web-ui) | `packages/web-ui` | A live studio to design, preview and export styled QR codes. |

```bash
pnpm install
pnpm dev      # start the studio at http://localhost:5173
